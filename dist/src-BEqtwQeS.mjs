import { n as __esm } from "./index.mjs";
import { a as file_default, i as init_esm_min, n as FormData, o as fetch_blob_default, r as formDataToBlob, s as init_fetch_blob, t as init_from } from "./from-DMfXXUDR.mjs";
...
var dist_default;
var init_dist = __esm({ "node_modules/.pnpm/data-uri-to-buffer@4.0.1/node_modules/data-uri-to-buffer/dist/index.js": (() => {
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-CJjrJzvU.mjs");
